...
import { createTransaction } from './routes/tracking/transaction/create';
...
import { reconcile } from './routes/tracking/transaction/reconcile';
import { del as deleteTransactions } from './routes/tracking/transaction/delete';
	...
	cors({
		origin: (origin) => {
			const allowedOrigins = [
				'http://tindecken.com',
				'https://tindecken.com',
				'https://paperwork.tindecken.com',
				'https://paperworkapi.tindecken.com',
				'https://192.168.1.99:9090',
...
app.route('/tind_tracking', reconcile);
app.route('/tind_tracking', deleteTransactions);
