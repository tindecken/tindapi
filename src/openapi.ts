    ...
    schemas: {
      ...
      CreateWallet: {
        ...
        properties: {
          ...
          monthPeriodId: { type: 'string', description: 'Defaults to active month period if not provided' },
        },
        required: ['name'],
      },
      UpdateWallet: {
        ...
        properties: {
          ...
          balance: { type: 'number' },
          monthPeriodId: { type: 'string', description: 'Set to null/undefined to clear, or a valid period id to assign' },
        },
        required: ['id'],
      },
      DeleteWalletRequest: {
