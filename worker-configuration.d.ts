/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: cbb9a0f2bd6b15847b9acf2f091fa02c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "SECRET_API_KEY">> {}
}
